...
export default function MockTest() {
  ...
  const [showSubmit, setShowSubmit] = useState(false) // 交卷确认弹窗
        ...
        <div className="max-w-2xl mx-auto">
          <div className="bg-white rounded-2xl border shadow-sm p-6 sm:p-10 text-center">
            ...
            <p className="text-gray-500 mb-2">
              已答 <span className="font-bold text-gray-700">{answeredCount}</span> / {questions.length} 题
            </p>
        ...
        <div className="bg-white border-b shadow-sm px-4 py-3">
          <div className="max-w-5xl mx-auto">
            ...
            <div className="flex gap-4 mt-2 text-xs text-gray-400">
              <span className="flex items-center gap-1"><span className="w-3 h-3 rounded bg-purple-100 inline-block" /> 已答</span>
              <span className="flex items-center gap-1"><span className="w-3 h-3 rounded bg-gray-100 inline-block" /> 未答</span>
      ...
      {showSubmit && (
        <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center px-4">
          <div className="bg-white rounded-2xl shadow-xl p-6 max-w-sm w-full text-center">
            <Send size={32} className="mx-auto mb-4 text-purple-600" />
            ...
            <div className="flex gap-3 mt-4">
              <button
                ...
                className="flex-1 py-2.5 border border-gray-300 rounded-xl font-semibold text-sm text-gray-600 hover:bg-gray-50 transition-colors"
              >
                继续答题
              </button>
              <button
