  ...
  return (
    <div>
      ...
      <section className="py-24 px-4 bg-gradient-to-b from-blue-50 to-white">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link to="/subjects" className="px-8 py-3.5 border-2 border-gray-300 font-semibold rounded-xl hover:border-blue-400 hover:text-blue-600 transition-colors text-base">
              浏览学习资源
            </Link>
          </div>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="p-6 rounded-xl border-2 hover:border-blue-400 transition-colors flex flex-col">
              ...
              <p className="text-sm text-gray-400 mb-3">Math</p>
              <p className="text-gray-600 text-sm leading-relaxed mb-4">代数、高级数学、问题解决与数据分析，全面覆盖SAT数学考点。</p>
            ...
            {/* 阅读与写作 */}
            <div className="p-6 rounded-xl border-2 hover:border-emerald-400 transition-colors flex flex-col">
              <div className="mb-4"><BookOpen size={32} className="text-emerald-600" /></div>
              <h3 className="text-xl font-bold mb-0.5">阅读与写作</h3>
              <p className="text-sm text-gray-400 mb-3">Reading & Writing</p>
              <p className="text-gray-600 text-sm leading-relaxed mb-4">信息与理解、修辞与表达、标准英语规范，提升综合语言能力。</p>
              <ul className="space-y-1.5 text-sm text-gray-600 flex-1 mb-6">
            ...
            {/* 模拟测试 */}
            <div className="p-6 rounded-xl border-2 hover:border-purple-400 transition-colors flex flex-col">
              <div className="mb-4"><PenLine size={32} className="text-purple-600" /></div>
              <h3 className="text-xl font-bold mb-0.5">模拟测试</h3>
              <p className="text-sm text-gray-400 mb-3">Full Practice Tests</p>
              <p className="text-gray-600 text-sm leading-relaxed mb-4">完整的SAT模拟试题，限时练习，体验真实考试环境。</p>
              <ul className="space-y-1.5 text-sm text-gray-600 flex-1 mb-6">
      ...
      <section className="py-20 px-4 bg-gray-50">
        <div className="max-w-5xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold text-center mb-4 text-gray-900">为什么选择我们？</h2>
          <p className="text-center mb-14 max-w-xl mx-auto text-gray-600">科学的备考方法 + 优质的练习资源，让你的SAT备考更有效率</p>
          <div className="grid md:grid-cols-2 gap-8">
            {[
              { icon: <TrendingUp size={28} className="text-blue-600" />, title: '智能题目推荐', desc: '根据你的答题情况，系统自动识别薄弱知识点，优先推送最需要加强的题目类型。' },
              { icon: <Clock size={28} className="text-blue-600" />, title: '限时答题训练', desc: '模拟真实SAT考试节奏，培养时间管理能力，让你在考场上从容应对每道题目。' },
              { icon: <Award size={28} className="text-blue-600" />, title: '详细解题分析', desc: '每道题都配有详细的解题思路和知识点讲解，不只告诉你答案，更帮你理解原理。' },
              { icon: <BookOpen size={28} className="text-blue-600" />, title: '权威题库资源', desc: '题目参照College Board官方样题风格设计，确保练习内容与真实SAT考试高度一致。' },
            ].map(f => (
              <div key={f.title} className="p-6 rounded-xl border bg-white flex gap-4">
