      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="space-y-6">
          {allMockTests.map(test => (
            <div key={test.id} className="bg-white dark:bg-slate-900 rounded-2xl border border-gray-200 dark:border-slate-700 shadow-sm overflow-hidden">
              {/* 套题标题 */}
              <div className="px-6 py-4 border-b border-gray-200 dark:border-slate-700 bg-gray-50/50 dark:bg-slate-800/50 flex items-center justify-between">
                <div>
                  <h2 className="text-lg font-bold text-gray-900 dark:text-slate-100">{test.title}</h2>
              ...
              <div className="divide-y divide-gray-200 dark:divide-slate-700">
                {test.modules.map((mod, idx) => {
                  ...
                  return (
                    <div
                      key={mod.name}
                      className="px-6 py-4 flex items-center justify-between hover:bg-gray-50/50 dark:hover:bg-slate-800/50 transition-colors"
                    >
